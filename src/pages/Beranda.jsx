    ...
    render()
    {
        return(
            <div>
                ...
                <p>Akan ada banyak hal yang dapat Kamu dipelajari. 
                ...
                beserta petunjuk instalasinya hingga koding.</p>
                <h3>Persiapan</h3>
                <p>Ada beberapa hal yang harus kamu siapkan untuk bisa mengikuti 
                    tutorial Web di sini. Asumsi bahwa kamu adalah pengguna sistem operasi windows. 
                    Berikut ini adalah daftarnya:</p>
                <ul>
                    <li>kode editor
